...
const DATA = [
  ...
  {
    id: 2,
    content: "Hi Samantha! I am Marissa Toronto. I would like to arrange a swap with you.",
    left: false
  },
  {
    id: 3,
  ...
  const renderItem = ({ item }) => {
    ...
    return (
      <View style={[styles.messageRow, alignStyle]}>
        ...
        <Text style={[styles.message, item.left?leftTextStyle:rightTextStyle]}>{item.content}</Text>
